...
const ServiceDetail = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(`https://pro.seawindsolution.com/MODEL/Webservices/getServicesBySlug/${slug}`, {
                headers,
            })
            .then((res) => {
    ...
    return (
        <div>
            <main>
                <Helmet>
                    <title>Influencer Market | Service Details</title>
                    <meta name="Service Details" content="This is my page Service Details." />
                </Helmet>
