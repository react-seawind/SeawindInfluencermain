...
const Services = (service) => {
    ...
    useEffect(() => {
        ...
        axios.get("https://pro.seawindsolution.com/MODEL/Webservices/getServices",
            // servicesData,
            {
                headers,
            }
    ...
    return (
        <div>
            <Helmet>
                <title>Influencer Market | Service</title>
                <meta name="Service" content="This is my page Service." />
            </Helmet>
            <div>
                <main>
                                        ...
                                        <div class="col-md-4 mb-4" key={val.Id}>
                                            <div class="service-content-box">
                                                ...
                                                <div class="service-content-details">
                                                    ...
                                                    <h5 >
                                                        <Link to={`/RF/services/${val.Slug}`}  >{val.Title}</Link>
                                                    </h5>
