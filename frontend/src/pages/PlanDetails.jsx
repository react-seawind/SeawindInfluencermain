...
const PlanDetails = () => {
    ...
    return (
        <div>
            <main>
                <Helmet>
                    <title>Influencer Market | Plan</title>
                    <meta name="Plan" content="This is my page Plan." />
                </Helmet>
                                    ...
                                    <>
                                        <div className="col-md-3 col-sm-6 p-1 bg-dark my-3">
                                            <div className="text-center px-2 py-4">
                                                ...
                                                <hr />
                                                <Link to={"/RF/signUp"} className="btn btn-danger align-items-center w-100"><b>Sign up</b></Link>
