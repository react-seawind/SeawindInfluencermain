...
const ProfilePage = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "https://pro.seawindsolution.com/MODEL/Webservices/getCategory",
        {
          headers: {
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      const response = await axios.get(
        `https://pro.seawindsolution.com/MODEL/Webservices/getProfile/${ID}`,
        {
          headers: {
            "x-api-key": "123456789123456789",
  ...
  const MySubmit = (e) => {
    ...
    axios
      .post(
        `https://pro.seawindsolution.com/MODEL/Webservices/updateProfile/${ID}`,
        formData,
        {
          headers,
        }
  ...
  return (
    <div>
      <div>
        <Helmet>
          <title>Influencer Market | Profile Page</title>
          <meta name="Profile Page" content="This is my page Profile Page." />
        </Helmet>
        <main>
