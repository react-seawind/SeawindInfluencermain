...
export default function Home() {
  ...
  return (
    <div>
      <Helmet >
        <title>Influencer Market | Home</title>
        <meta name="Home" content="This is my page home." />
      </Helmet>
      <section>
        <div >
          <Slider {...settings}>
              ...
              <div>
                ...
                <Slider {...settings}>
                  {BANNER?.map((val) => {
                    return (
                      <div>
                        <img className="img-fluid" src={val.image} alt="Slider 1" />
                      </div>
                    )
                  })}
                </Slider>
          ...
          <Container className="becomemodel">
            <Row>
              ...
              >
                ...
                <Link to={"/RF/signUp"} className="btn btn-danger">Apply Now</Link>
