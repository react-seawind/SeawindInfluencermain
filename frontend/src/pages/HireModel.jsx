...
const HireModel = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Influencer Market | Hire Model</title>
        <meta name="Hire Model" content="This is my page Hire Model." />
      </Helmet>
      <main>
                    ...
                    <div className="row">
                      <div className="col-md-6 mb-4">
                        <div className="form-group">
                          ...
                          >
                            <option aria-readonly selected>
                              Choose Category
                            </option>
                            <option value="male-model">Female</option>
                            <option value="female-model">Male</option>
                            <option value="celebrities-model">
                              Celebrities
                            </option>
                            <option value="Kids-model">Kids</option>
                          </select>
                        </div>
                      </div>
                      <div className="col-md-6 mb-4">
