...
const ContactUS = () => {
  ...
  const MySubmit = (e) => {
    ...
    axios.post("https://pro.seawindsolution.com/MODEL/Webservices/contactUs",
      contactdata,
      {
        headers,
      }
  ...
  return (
    <div>
      <main>
        <Helmet>
          <title>Influencer Market | Contact US</title>
          <meta name="Contact US" content="This is my page Contact US." />
        </Helmet>
