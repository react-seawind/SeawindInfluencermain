...
const ChangePassword = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        "https://pro.seawindsolution.com/MODEL/Webservices/changePassword",
        formData,
        {
          headers,
        }
  ...
  return (
    <main>
      <section className="inner-page-banner">
        <Helmet>
          <title>Influencer Market | Change Password</title>
          <meta name="Change Password" content="This is my page Change Password." />
        </Helmet>
